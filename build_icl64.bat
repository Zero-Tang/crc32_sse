...
%iclpath%\icl.exe .\crc32.c /I"%incpath%\api" /I"%incpath%\crt" /Z7 /nologo /W3 /WX /Od /D"_icl" /D"_crc_core" /D"_amd64" /FAcs /Fa"%objpath%\crc32c.cod" /Fo"%objpath%\crc32c.obj" /Fd"%objpath%\vc90.pdb" /arch:SSE4.2 /TC /c
